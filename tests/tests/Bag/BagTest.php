...
namespace Neuedev\Apineu\Tests\Bag;

use Neuedev\Apineu\Bag\Bag;
use Neuedev\Apineu\Bag\BagEntry;
use Neuedev\Apineu\Bag\NotABagEntryException;
...
class BagTest extends TestCase
{
    ...
    {
        $message = preg_quote('Argument #2 ($value) must be of type Neuedev\Apineu\Bag\BagEntryInterface, string given');
    ...
    {
        $message = preg_quote('Argument #1 ($entry) must be of type Neuedev\Apineu\Bag\BagEntryInterface, class@anonymous given');
        $this->expectExceptionMessageMatches("/{$message}/");
