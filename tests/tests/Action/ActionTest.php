...
use Neuedev\Apineu\Action\ActionInput;
...
class ActionTest extends ApiResourcesTest
{
    public function test_missing_name()
    {
        ...
        $this->expectExceptionMessage('Typed property Neuedev\Apineu\Action\Action::$name must not be accessed before initialization');
    ...
    {
        $this->expectException(Error::class);
        $this->expectExceptionMessage('Typed property Neuedev\Apineu\Action\Action::$params must not be accessed before initialization');
