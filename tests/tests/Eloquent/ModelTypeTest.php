...
namespace Neuedev\Apineu\Tests\Eloquent;

use Neuedev\Apineu\Eloquent\Model;
use Neuedev\Apineu\Eloquent\ModelRelationResolver;
...
use Neuedev\Apineu\Test\Eloquent\ApiResourcesEloquentTest;
...
class ModelTypeTest extends ApiResourcesEloquentTest
{
    ...
    public function test_model_type_missing_model_class()
    {
        ...
        $this->expectExceptionMessageMatches('/^Missing Eloquent model in class Neuedev\\\Apineu\\\Test\\\Eloquent\\\TestModelType@anonymous/');
